...
TRACE_EVENT(sched_compute_energy,
	...
	TP_printk("pid=%d comm=%s util=%lu prev_cpu=%d prev_energy=%lu eval_cpu=%d eval_energy=%lu best_energy_cpu=%d best_energy=%lu, fcpu=%u s=%lu m=%lu c=%lu, fcpu=%u s=%lu m=%lu c=%lu, fcpu=%u s=%lu m=%lu c=%lu",
...
TRACE_EVENT(sched_task_handler,
	...
	TP_printk("comm=%s pid=%d param=%d val=%d callers=0x%lx <- 0x%lx <- 0x%lx <- 0x%lx <- 0x%lx <- 0x%lx",
